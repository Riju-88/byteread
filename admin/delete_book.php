 ...
 <?php require '../alert.php'; ?>
    ...
    <div class="hero min-h-screen bg-base-200">
        <div class="hero-content flex-col lg:flex-row">
            ...
            <div class="mt-4">
                <h2 class="text-xl text-center font-semibold mb-2">Delete Book</h2>
                <form action="delete_book_process.php" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="book_title" id="book_name" required placeholder="Book Name"
                                class="input input-bordered w-full" value=" <?php echo trim($book->title); ?>" readonly>
                        </div>
                        <div class="form-control">
                            <label for="author" class="block font-semibold">Author:</label>
                            <input type="text" name="author" id="author" required placeholder="Author"
                                class="input input-bordered w-full" value=" <?php echo trim($book->author); ?>" readonly>
                        </div>
                        <div class="form-control">
                            <label for="genre" class="block font-semibold">Genre:</label>
                            <input type="text" name="genre" id="genre" required placeholder="Genre"
                                class="input input-bordered w-full" value=" <?php echo trim($book->genre); ?>" readonly>
                        </div>
                        
                       
                        <div class="form-control mt-6">
                            <input type="submit" value="Delete Book" class="btn btn-error w-full">
                        </div>
                    </div>
                </form>
            </div>
